 ...
 * into sembilan-router-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are sembilan-router fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic sembilan-router variant set for a single upstream Kiro model.
 *
 ...
 * into sembilan-router variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
