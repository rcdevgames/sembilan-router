 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what sembilan-router needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a sembilan-router
...
/**
 * Detect whether a model id refers to a sembilan-router synthetic agentic variant.
...
/**
 * Detect whether a model id is a sembilan-router synthetic thinking variant
...
/**
 * Resolve a sembilan-router model id to the real upstream Kiro model id, plus flags
