...
console.log("📦 Building Sembilan Router CLI package with Next.js...\n");
...
// e.g. .next-cli-build/standalone/sembilan-router/server.js
...
// Strip better-sqlite3 (native) — it lives in ~/.sembilan-router/runtime to avoid
...
if (fs.existsSync(betterDir)) {
  ...
  console.log("✅ Stripped better-sqlite3 (lives in ~/.sembilan-router/runtime)");
}
console.log("");
