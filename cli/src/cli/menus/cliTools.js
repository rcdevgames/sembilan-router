...
async function buildDroidHeader() {
  ...
  const { installed, hasSembilanRouter, settings } = result.data;
...
async function buildOpenCodeHeader() {
  ...
  const { installed, hasSembilanRouter, opencode } = result.data;
