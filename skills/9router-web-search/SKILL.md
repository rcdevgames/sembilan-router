---
name: sembilan-router-web-search
description: Web search via Sembilan Router /v1/search using Tavily / Exa / Brave / Serper / SearXNG / Google PSE / Linkup / SearchAPI / You.com / Perplexity. Use when the user wants to search the web, look up information, find articles, or query a search engine.
---

# Sembilan Router — Web Search
...
curl -X POST $NINEROUTER_URL/v1/search \
  ...
  -d '{"model":"tavily","query":"Sembilan Router open source","max_results":5}'
```
...
{
  "provider": "tavily",
  "query": "Sembilan Router open source",
  "results": [
    {
