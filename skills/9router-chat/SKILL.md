---
name: sembilan-router-chat
description: Chat / code generation via Sembilan Router using OpenAI /v1/chat/completions or Anthropic /v1/messages format with streaming + auto-fallback combos. Use when the user wants to ask an LLM, generate code, summarize text, or run prompts through Sembilan Router.
---

# Sembilan Router — Chat
