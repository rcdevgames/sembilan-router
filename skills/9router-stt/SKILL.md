---
name: sembilan-router-stt
description: Speech-to-text via Sembilan Router /v1/audio/transcriptions using OpenAI Whisper / Groq / Gemini / Deepgram / AssemblyAI / NVIDIA / HuggingFace models. Use when the user wants to transcribe audio, convert speech to text, or get subtitles from audio files.
---

# Sembilan Router — Speech-to-Text
