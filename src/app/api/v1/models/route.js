...
// and break recursive loops between sembilan-router instances connected to each other.
...
export async function buildModelsList(kindFilter, options = {}) {
  ...
  // sembilan-router instance's fetchCompatibleModelIds — skip dynamic fetch to break
