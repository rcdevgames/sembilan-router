...
export const APP_CONFIG = {
  ...
  description: "Sembilan Router Gateway",
  version: pkg.version,
};
...
export const UPDATER_CONFIG = {
  npmPackageName: "@rcdevgames/sembilan-router",
  installCmd: "npm i -g @rcdevgames/sembilan-router",
  installCmdLatest: "npm i -g @rcdevgames/sembilan-router@latest --prefer-online",
