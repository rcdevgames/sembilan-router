...
// Check if a system-level tailscaled is running (uses system socket, not Sembilan Router's custom one).
 ...
 * State always lives in ~/.sembilan-router/tailscale/ via --statedir.
 */
